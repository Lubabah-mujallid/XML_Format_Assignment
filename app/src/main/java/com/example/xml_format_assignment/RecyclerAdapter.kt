...
class RecyclerAdapter (val context: Context, val messages: ArrayList<Students>):
    ...
    override fun onBindViewHolder(holder: RecyclerAdapter.ViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            tvRecyclerID.text = message.id.toString()
            tvRecyclerName.text = message.name
            tvRecyclerScore.text = message.marks.toString()
        }
    }
